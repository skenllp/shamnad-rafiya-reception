/* =========================================================
   SHAMNAD & AYISHA RAFIYA — WEDDING INVITATION
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  --------------------------------------------------------- */
  const WEDDING_DATE = new Date('2026-10-11T17:00:00');
  ...
  /* Gallery/lightbox markup is only present when a gallery section
     exists on the page — guard so its absence never breaks the
     music player, particles or scroll motion set up below. */
  if (lightbox && lightboxImg && lightboxClose && lightboxPrev && lightboxNext && masonryItems.length) {
